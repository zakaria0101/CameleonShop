...
<head>
    ...
    <title>Cameleon shop | Femmes</title>
...
<!--------------------------- Categorie Hommes Hauts  --------------------->   
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($col = mysqli_fetch_assoc($result)) {
            ...
            if ($categorie == 'Femmes' && $Sous_categorie == 'Hauts') { 
    ?>
...
<!--------------------------- Categorie Hommes Bas ------------------------->  
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($col = mysqli_fetch_assoc($result)) {
            ...
            $categorie = $col['cat'];
            $Sous_categorie = $col['sous_cat'];
            if ($categorie == 'Femmes' && $Sous_categorie == 'Bas') { 
    ?>
...
<!---------------------------End Categorie Hommes Bas  --------------------->   
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($col = mysqli_fetch_assoc($result)) {
            ...
            $categorie = $col['cat'];
            $Sous_categorie = $col['sous_cat'];
            if ($categorie == 'Femmes' && $Sous_categorie == 'Chaussurs') { 
    ?>
