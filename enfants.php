...
<head>
    ...
    <title>Cameleon shop | Enfants</title>
...
<!------------------------------- Categorie Recherche  --------------------->
    ...
    <div class="btns" >
        ...
        <button class="category" id="acces">Chaussurs</button>
    </div>
    <div class="wrapper">
...
<!--------------------------- Categorie Hommes Hauts  --------------------->   
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($col = mysqli_fetch_assoc($result)) {
            ...
            if ($categorie == 'Enfants' && $Sous_categorie == 'Hauts') { 
    ?>
...
<!--------------------------- Categorie Hommes Bas ------------------------->  
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($col = mysqli_fetch_assoc($result)) {
            ...
            $categorie = $col['cat'];
            $Sous_categorie = $col['sous_cat'];
            if ($categorie == 'Enfants' && $Sous_categorie == 'Bas') { 
    ?>
...
<!---------------------------End Categorie Hommes Bas  --------------------->   
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($col = mysqli_fetch_assoc($result)) {
            ...
            $categorie = $col['cat'];
            $Sous_categorie = $col['sous_cat'];
            if ($categorie == 'Enfants' && $Sous_categorie == 'Chaussurs') { 
    ?>
